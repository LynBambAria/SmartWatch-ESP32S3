...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_imagebutton_set_src(ui->screen_imgbtn_1, LV_IMAGEBUTTON_STATE_RELEASED, &_steps_RGB565A8_50x50, NULL, NULL);
    lv_imagebutton_set_src(ui->screen_imgbtn_1, LV_IMAGEBUTTON_STATE_PRESSED, &_steps_RGB565A8_50x50, NULL, NULL);
    lv_imagebutton_set_src(ui->screen_imgbtn_1, LV_IMAGEBUTTON_STATE_CHECKED_RELEASED, &_steps_RGB565A8_50x50, NULL, NULL);
    lv_imagebutton_set_src(ui->screen_imgbtn_1, LV_IMAGEBUTTON_STATE_CHECKED_PRESSED, &_steps_change_RGB565A8_50x50, NULL, NULL);
    ...
    lv_imagebutton_set_src(ui->screen_imgbtn_2, LV_IMAGEBUTTON_STATE_RELEASED, &_heart_RGB565A8_50x50, NULL, NULL);
    lv_imagebutton_set_src(ui->screen_imgbtn_2, LV_IMAGEBUTTON_STATE_PRESSED, &_heart_RGB565A8_50x50, NULL, NULL);
    lv_imagebutton_set_src(ui->screen_imgbtn_2, LV_IMAGEBUTTON_STATE_CHECKED_RELEASED, &_heart_RGB565A8_50x50, NULL, NULL);
    lv_imagebutton_set_src(ui->screen_imgbtn_2, LV_IMAGEBUTTON_STATE_CHECKED_PRESSED, &_heart_change_RGB565A8_50x50, NULL, NULL);
